(function (global) {
  ...
  const classify = (error) => {
    ...
    const messages = {
      ...
      APPOINTMENT_NOT_FOUND: 'Esa cita ya no está disponible. Elige o crea otra cita.',
      QUOTE_ACTION_NOT_AVAILABLE: 'Esa cita ya no es válida para esta cotización. Elige otra cita o una acción diferente.',
      QUOTE_ACTION_NOT_AUTHORIZED: 'Esa cita no puede asociarse a esta cotización. Elige una cita propia o una acción diferente.',
      QUOTE_ACTION_LEGACY_NOT_SUPPORTED: 'Esta cotización fue enviada con una versión anterior. Registra la próxima acción directamente en el CRM.',
