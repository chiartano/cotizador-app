    ...
    setTimeout(() => {
        ...
        function checkVersion() {
            ...
            if (savedVersion !== APP_VERSION) {
                ...
                // 2. Si existe config vieja, intentamos preservarla pero la nueva estructura manda
                if(oldConfig.globales) {
                    alert(`App actualizada a la versión ${APP_VERSION}. Revise la configuración.`);
                }
                
                // 3. Guardar nueva versión
                localStorage.setItem('app_version', APP_VERSION);
                
                // Opcional: Forzar recarga limpia si hay cambios críticos
...
----------------------------`;
        ...
        function compartirCompleto() {
            ...
            texto += `💰 *TOTAL NETO: ${fmtMoney(final)}*\n`;
