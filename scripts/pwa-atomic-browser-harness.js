...
const publishedAgendaFiles = agendaFiles.filter(file => !['agenda/quoteToCrm.js', 'agenda/productSpec.js', 'agenda/intake.js'].includes(file));
const CURRENT_CACHE = 'cotizador-v7.22';
