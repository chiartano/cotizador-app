...
function commercialInvariantErrors(dir) {
  ...
  if (!files['sw.js'].includes("const CACHE_NAME = 'cotizador-v7.10';")) {
  ...
  if (!pwaTest.includes("candidateSw.replace(\"const CACHE_NAME = 'cotizador-v7.9';\", \"const CACHE_NAME = 'cotizador-v7.10';\")")) {
...
const mutations = [
  ...
  },
  {
    ...
    file:'sw.js',
    search:"const CACHE_NAME = 'cotizador-v7.10';",
    replacement:"const CACHE_NAME = 'cotizador-v7.10-mutado';"
  },
  {
